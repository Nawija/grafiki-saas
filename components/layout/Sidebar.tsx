                                ...
                                {organizations.map((org) => (
                                    <li key={org.id}>
                                        <Link
                                            ...
                                            className="group flex gap-x-3 rounded-md p-2 text-sm font-medium leading-6 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50"
                                        >
